...
# S_map_deb.writeto('../FITS_file/new_fits/S_map_deb_new_2025_19.fits')
# sigma_S_map.writeto('../FITS_file/new_fits/sigma_S_new_2025_19.fits')

#%%
S_map_deb =  fits.open('../FITS_file/new_fits/S_map_deb_new_2025_19.fits')[1]
sigma_S_map = fits.open('../FITS_file/new_fits/sigma_S_new_2025_19.fits')[1]
...
plt.tight_layout()
plt.savefig('../plots/2025/19/S_map_deb.png')
plt.show()
...
plt.ylabel('Number')
plt.savefig('../plots/2025/19/S_deb_hist.png')
plt.show()
...
plt.xlabel('debiased S')
plt.ylabel('Number')
plt.savefig('../plots/2025/19/sigma_S_hist.png')
plt.show()
