...
plt.tight_layout()
plt.legend()
plt.savefig('../plots/2025/9/I_vs_N.png')
plt.show()
...
plt.tight_layout()
plt.legend()
plt.savefig('../plots/2025/9/p_vs_N.png')
plt.show()
...
plt.tight_layout()
plt.legend()
plt.savefig('../plots/2025/9/S_vs_N.png')
plt.show()
...
plt.tight_layout()
plt.legend()
plt.savefig('../plots/2025/9/pS_vs_N.png')
plt.show()
...
plt.tight_layout()
plt.legend()
plt.savefig('../plots/2025/9/p_vs_I.png')
plt.show()
...
plt.tight_layout()
plt.legend()
plt.savefig('../plots/2025/9/S_vs_I.png')
plt.show()
...
plt.tight_layout()
plt.legend()
plt.savefig('../plots/2025/9/pS_vs_I.png')
plt.show()
...
plt.tight_layout()
plt.legend()
plt.savefig('../plots/2025/9/S_vs_p.png')
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig('../plots/2025/9/I_vs_N_notOF.png')
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig('../plots/2025/9/p_vs_N_notOF.png')
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig('../plots/2025/9/S_vs_N_notOF.png')
plt.show()
...
plt.xticks(np.array([1e22,1e23,1e24]))
plt.legend()
plt.savefig('../plots/2025/9/pS_vs_N_notOF.png')
plt.tight_layout()
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig('../plots/2025/9/p_vs_I_notOF.png')
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig('../plots/2025/9/S_vs_I_notOF.png')
plt.show()
...
plt.tight_layout()
plt.legend()
plt.savefig('../plots/2025/9/pS_vs_I_notOF.png')
plt.show()
#%%
...
plt.tight_layout()
plt.legend()
plt.savefig('../plots/2025/9/S_vs_p_notOF.png')
plt.show()
