...
gc1.show_circles(RA_array,DEC_array,0.002)
...
# res = bootstrapscipy(data, Functions.binning_equal_width_vbootstrap,n_resamples=10000,paired = True,vectorized=False, random_state=0)
# label_temp = r'log(p{frac}) = C + $\alpha$log(S){linebreak} $\alpha$: {alpha_s:.3f}{pm}{error:.3f}'.format(frac = r'$\%$',alpha_s = param[1],pm = r'$\pm$',error=res.standard_error,linebreak='\n')
# # plt.plot(x,y,'tab:green',linewidth = 2.5,label = label_temp)
# plt.plot(x,y,'tab:red',linewidth = 2.5,label = label_temp)
# plt.title(r'$p\%$ vs $S$')
# plt.xscale('log')
...
# First plot
ax[0].imshow(I_C2_R1.data,origin = 'lower')
ax[0].set_title('Ridge')
# ax[0].legend()
# ax[0].grid()

# Second plot
ax[1].imshow(I_C2_rest.data,origin = 'lower')
ax[1].set_title('Rest')
# ax[1].legend()
# ax[1].grid()
...
weights1 = eI_C2_R1_array.copy()

array2 = p_C2_R1_array.copy()
weights2 = ep_C2_R1_array.copy()

array3 =I_C2_rest_array.copy()
weights3 = eI_C2_rest_array.copy()

array4 = p_C2_rest_array.copy()
weights4 = ep_C2_rest_array.copy()

plt.figure(figsize=(12,8))
plt.scatter(array1,array2,c='#4575b4',label = 'R1')
plt.scatter(array3,array4, c='#d73027',label = r'R2,R3,R4,R5,R6{linebreak}log(p{frac}) = C + $\alpha${I}log($I$)'.format(frac = r'$\%$',linebreak='\n',I = r'$_{I}$'))
...
plt.figure(figsize=(12,8))
plt.scatter(array1,array2,c='#4575b4',label = 'R1')
plt.scatter(array3,array4, c='#BCBD22',label = r'R2,R3,R4,R5,R6{linebreak}log(p{frac}) = C + $\alpha${nh2}log($N$)'.format(frac = r'$\%$',linebreak='\n',nh2 = r'$_{N}$'))
...
plt.figure(figsize=(12,8))
plt.scatter(array1,array2,c='#4575b4',label = 'R1')
plt.scatter(array3,array4, c='#BCBD22',label = r'R2,R3,R4,R5,R6{linebreak}log(S) = C + $\alpha$log(p{frac})'.format(frac = r'$\%$',linebreak='\n'))
...
weights2 = np.sqrt((ep_C2_R1_array*s_C2_R1_array)**2 + (es_C2_R1_array*p_C2_R1_array)**2)
...
plt.figure(figsize=(12,8))
plt.scatter(array1,array2,c='#4575b4',label = 'R1')
plt.scatter(array3,array4, c='#BCBD22',label = r'R2,R3,R4,R5,R6{linebreak}log(p{frac}*S) = C + $\alpha$log($N$)'.format(frac = r'$\%$',linebreak='\n'))
...
plt.figure(figsize=(12,8))
plt.scatter(array1,array2,c='#4575b4',label = 'R1')
plt.scatter(array3,array4, c='#d73027',label = r'R2,R3,R4,R5,R6{linebreak}log(p{frac}) = C + $\alpha$log($T$)'.format(frac = r'$\%$',linebreak='\n'))
...
plt.figure(figsize=(12,8))
plt.scatter(array1,array2,c='#4575b4',label = 'R1')
plt.scatter(array3,array4, c='#d73027',label = r'R2,R3,R4,R5,R6{linebreak}log(T) = C + $\alpha$log($N$)'.format(frac = r'$\%$',linebreak='\n'))
...
plt.figure(figsize=(12,8))
plt.scatter(array1,array2,c='#4575b4',label = 'R1')
plt.scatter(array3,array4, c='#d73027',label = r'R2,R3,R4,R5,R6{linebreak}log(p{frac}) = C + $\alpha$log($T$)'.format(frac = r'$\%^{N_{dec}}$',linebreak='\n'))
...
plt.scatter(array5,array6,c = '#7fbc41',label = r'R6{linebreak}log(p{frac}) = C + $\alpha$log(I)'.format(frac = r'$\%$',linebreak='\n'))
...
plt.scatter(array1,array2,c='#4575b4',label = 'R1')
plt.scatter(array3,array4,c='#d73027',label = 'R2,R3,R4,R5')
plt.scatter(array5,array6,c = '#7fbc41',label = r'R6{linebreak}log(p{frac}) = C + $\alpha$log($N$)'.format(frac = r'$\%$',linebreak='\n',nh2 = r'$_{N}$'))
...
plt.scatter(array1,array2,c='#4575b4',label = 'R1')
plt.scatter(array3,array4,c='#d73027',label = 'R2,R3,R4,R5')
plt.scatter(array5,array6,c = '#7fbc41',label = r'R6{linebreak}log(p{frac}) = C + $\alpha$log(S)'.format(frac = r'$\%$',linebreak='\n'))
...
plt.scatter(array1,array2,c='#4575b4',label = 'R1')
plt.scatter(array3,array4,c='#d73027',label = 'R2,R3,R4,R5')
plt.scatter(array5,array6,c = '#7fbc41',label = r'R6{linebreak}log(p{frac}*S) = C + $\alpha$log($N$)'.format(frac = r'$\%$',linebreak='\n'))
...
plt.scatter(array1,array2,c='#4575b4',label = 'R1')
plt.scatter(array3,array4,c='#d73027',label = 'R2,R3,R4,R5')
plt.scatter(array5,array6,c = '#7fbc41',label = r'R6{linebreak}log(p{frac}) = C + $\alpha$log(T)'.format(frac = r'$\%$',linebreak='\n'))
...
plt.scatter(array1,array2,c='#4575b4',label = 'R1')
plt.scatter(array3,array4,c='#d73027',label = 'R2,R3,R4,R5')
plt.scatter(array5,array6,c = '#7fbc41',label = r'R6{linebreak}log(p{frac}) = C + $\alpha$log(T)'.format(frac = r'$\%^{N_{dec}}$',linebreak='\n'))
