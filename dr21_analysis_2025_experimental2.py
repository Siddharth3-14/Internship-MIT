...
plt.savefig('../plots/2025/38/Column_density.png')
plt.close()
# plt.show()
...
plt.tight_layout()
plt.savefig('../plots/2025/38/Angle_dispersion.png')
plt.close()
# plt.show()
...
plt.ylabel('Number')
plt.savefig('../plots/2025/38/hist_debiased_S.png')
plt.close()
# plt.show()
...
plt.xlabel('debiased S')
plt.ylabel('Number')
plt.savefig('../plots/2025/38/hist_sigma_S.png')
plt.close()
# plt.show()
